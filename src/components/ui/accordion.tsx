...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex group">
      ...
      >
        {children}
        <Icon icon={ArrowDown01Icon} strokeWidth={2} data-slot="accordion-trigger-icon" className="pointer-events-none shrink-0 group-aria-expanded/accordion-trigger:rotate-180 transition-transform duration-300" />
      </AccordionPrimitive.Trigger>
