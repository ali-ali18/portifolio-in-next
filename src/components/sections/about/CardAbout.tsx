...
export function CardAbout({ src, alt }: CardAboutProps) {
  return (
    <div className="border w-full h-full rounded-3xl overflow-hidden flex flex-col md:flex-row">
      ...
      <div className="flex flex-col items-start justify-center gap-8.5 py-10 px-14">
        <span className="text-sm uppercase text-muted-foreground font-medium">
          Desenvolvedor full stack <br /> & UI/UX Designer
        </span>

        <p className="max-w-xl text-2xl leading-tight font-medium">
